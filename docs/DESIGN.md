...
| `≤ 699px` | Single column throughout; rings shrink; tab bar (Today/Week/Month) becomes equal-width flex items instead of centered links; table cell padding tightens from 12px to 10px |
...
- **Tabs (Today/Week/Month)**: text buttons, active tab colored `--accent-text` with a matching underline.
